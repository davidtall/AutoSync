...
git clone --depth 1 https://github.com/kenzok8/wall && rm -rf wall/shadowsocks-rust && mv -n wall/* ./ ; rm -rf {UnblockNeteaseMusic,adguardhome,alist,ddns-go,dockerd,filebrowser,gost,lucky,sagernet-core,smartdns,ucl,upx-static,upx} && rm -rf wall
...
git clone --depth 1 https://github.com/sirpdboy/luci-app-ddns-go ddnsgo && mv -n ddnsgo/{luci-app-ddns-go,ddns-go} ./; rm -rf ddnsgo
